...
-(CGRect) rect
{
	...
	CGRect r = CGRectMake( _position.x - s.width/2, _position.y-s.height/2, s.width, s.height);
	return r;
}
...
-(CGRect) rect
{
	...
	r.origin.x = _position.x - r.size.width / 2;
	r.origin.y = _position.y - r.size.height / 2;
